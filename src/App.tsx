...
function App() {
  const [city, setCity] = useState('Freehold');
  ...
  const [latitude, setLatitude] = useState('37.312122');
  const [longitude, setLongitude] = useState('-122.0445');
  ...
  const [autoLocation, setAutoLocation] = useState('Marlboro');
